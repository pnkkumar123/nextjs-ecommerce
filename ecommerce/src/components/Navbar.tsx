  ...
  return (
    <div className="w-full h-20 bg-white border-b-[1px] border-b-gray-400 sticky top-0 z-50 ">
      <nav className="h-full max-w-screen-xl mx-auto px-4 xl:px-0 flex items-center justify-between gap-2">
        ...
        <div className="relative w-full hidden lg:inline-flex lg:min-w-[600px] h-10 text-base text-primeColor border-[1px] border-black gap-2 justify-between px-6 rounded-md  ">
          <input
            type="text"
            placeholder="search"
